...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] testMcpMrns = {
                ...
                "urn:mrn:mcp:service:smart:kor:instance:smart:mesis-np",
                "urn:mrn:mcp:service:smart:kor:instance:smart:mesis-owhi",
                ...
                "urn:mrn:mcp:service:smart:kor:specification:smart:mesis-np",
                "urn:mrn:mcp:service:smart:kor:specification:smart:mesis-owhi",
                ...
                "urn:mrn:mcp:service:smart:kor:design:smart:mesis-np",
                "urn:mrn:mcp:service:smart:kor:design:smart:mesis-owhi",
